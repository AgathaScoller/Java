...
- **Basics/** – syntax, variables, control flow, and data types  
- **OOP/** – object-oriented programming: classes, inheritance, polymorphism, and encapsulation  
- **DataStructures/** – implementation and analysis of fundamental data structures  
- **Projects/** – small applications and testing environments  
- **Utils/** – reusable components and helper classes  
